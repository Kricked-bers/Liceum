...
def test_filter_by_state_basic_state(input_dict):
...
def test_filter_by_state_type_state(input_dict):
    assert filter_by_state(input_dict, 52154) == "-1"
    assert filter_by_state(input_dict, ("NotStr", "15")) == "-1"


def test_sort_by_date_basic_default(input_dict):
